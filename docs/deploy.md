...
**Releases** é o lugar certo para a versão: zip do código + notas. A tag `v*` dispara isso automaticamente (atual: `v0.8.5`).
...
1. GitHub → Releases → `v0.8.5` → Source code (zip)
...
- [ ] Migrações 001–064 aplicadas no Supabase de produção
