  ...
  return (
    <FlowEditorProvider initialFlow={initialFlow} initialNodes={initialNodes}>
      <div className="flex min-h-0 flex-1 flex-col">
        ...
        {/* `rounded-lg`, the one card radius in the system. The stage is
            a bordered surface like any other; `rounded-xl` here put a
            2px-wider corner directly beside the `rounded-lg` node cards
            it contains. */}
        <div className="relative mx-4 min-h-0 flex-1 overflow-hidden rounded-lg border border-border bg-card-2 sm:mx-6 lg:mx-8">
