            ...
            <div className="mb-2 flex items-center gap-2">
              ...
              {sections.length > 1 && (
                <Button
                  ...
                  className="shrink-0 text-danger-ink hover:bg-danger-soft"
        ...
        {cfg.media_url ? (
          <div className="flex items-center gap-2 rounded-md border border-border bg-muted px-3 py-2 text-xs">
            ...
            <a
              ...
              className="min-w-0 flex-1 truncate text-foreground transition-colors duration-(--dur-1) hover:text-primary hover:underline"
            ...
            <button
              ...
              className="grid size-6 shrink-0 place-items-center rounded-sm text-muted-foreground transition-colors duration-(--dur-1) hover:bg-muted hover:text-foreground pointer-coarse:size-11"
          ...
          <button
            ...
            disabled={uploading}
            className="flex w-full items-center justify-center gap-2 rounded-md border border-dashed border-border bg-card px-3 py-4 text-xs text-muted-foreground transition-colors duration-(--dur-1) hover:border-border hover:bg-muted hover:text-foreground disabled:cursor-not-allowed disabled:opacity-60"
          >
            {uploading ? (
              <>
