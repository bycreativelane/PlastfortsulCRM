                  ...
                  >
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        ...
                        {status === 'revoked' && (
                          <Badge className="border-border bg-muted text-muted-foreground eyebrow">
                            {t('revoked')}
                          </Badge>
                        )}
                        {status === 'expired' && (
                    ...
                    {status === 'active' && (
                      <RequireRole min="admin">
                        <Button
                          ...
                          className="border-danger/30 bg-danger-soft text-danger-ink hover:border-danger/50 hover:bg-danger-soft/70 hover:text-danger-ink self-start sm:self-auto"
                        >
                          {revoking === k.id ? (
        ...
        {createdKey ? (
          <>
            ...
            <div className="space-y-1.5">
              <FieldLabel>{t('apiKeyLabel')}</FieldLabel>
