...
export function TemplateManager() {
  ...
  return (
    <section className="animate-in fade-in-50 space-y-4 duration-(--dur-3)">
      <SettingsPanelHead
        title={t('title')}
          ...
          {templates.map((template) => {
            ...
            return (
              <Panel key={template.id}>
                <PanelBody className="flex items-start justify-between pt-4">
                  <div className="min-w-0 flex-1 space-y-2">
                    <div className="flex flex-wrap items-center gap-2">
                      <h3 className="text-foreground font-medium">
                        {template.name}
                      </h3>
                      {/* Two channels on purpose: category is taxonomy, so
                          it is a grey rounded-rectangle Tag; status is
                          state, so it is a coloured pill. The category
                          used to be a purple/blue/amber wash whose shades
                          are outside the @theme remap — three colour foci
      ...
      >
        <DialogContent className="bg-popover border-border max-h-vh-90 overflow-y-auto sm:max-w-2xl">
          <DialogHeader>
          ...
          <div className="space-y-4 py-2">
            ...
            <div className="space-y-2">
              <FieldLabel>{t('bodyText')}</FieldLabel>
              <Textarea
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <FieldLabel>{t('buttons')}</FieldLabel>
                <Button
                  type="button"
                  variant="outline"
                  size="sm"
