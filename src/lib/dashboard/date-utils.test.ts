...
describe('mondayIndex', () => {
  // Dates carry an explicit T00:00:00 so they parse in LOCAL time.
  // ECMA-262 parses the date-only form ("2026-05-18") as UTC midnight,
  // while mondayIndex() reads getDay(), which is local — so west of
  // Greenwich the bare form lands on the previous day and every
  // assertion here shifts by one. CI runs in UTC and never saw it.
