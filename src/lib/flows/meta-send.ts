...
//
// Opt-out (`contacts.opted_out`) is enforced on the *automation*
// sender (`automations/meta-send.ts`), not here. A Flow is the customer
// navigating a menu inside the 24-hour window they opened; refusing
// mid-tree would stall legitimate service. Marketing templates after a
// Wait are the automation engine's job.
//
