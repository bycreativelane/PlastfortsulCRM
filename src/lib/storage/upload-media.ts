...
/**
 * Outbound chat attachments (migration 023). Public bucket — Meta fetches
 * the URL at send time, and our own bubbles render the same URL afterwards,
 * which is why an object here is never deleted once a message has used it.
 */
